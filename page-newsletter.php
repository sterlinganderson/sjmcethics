...
function mce_init_form(){
    jQuery(document).ready( function($) {
      ...
      options = { url: 'http://wisc.us3.list-manage.com/subscribe/post-json?u=2369c60a3bd5a0eb8cb17a152&id=5bf3f4aff3&c=?', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
